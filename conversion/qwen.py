...
# DFlash draft model: lightweight Qwen3-based decoder that reads target hidden
# states and predicts multiple tokens ahead. config.json always reports
# model_type "qwen3"; the GGUF is written under the dedicated "dflash" arch so
# the runtime loads it via LLM_ARCH_DFLASH. It shares the target's tokenizer.
