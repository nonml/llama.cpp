...
struct server_routes {
    ...
    server_http_context::handler_t post_slot_checkpoint;
    server_http_context::handler_t post_slot_rollback;
    server_http_context::handler_t post_slot_fork;
...
private:
    ...
    std::unique_ptr<server_res_generator> handle_slot_checkpoint(const server_http_req & req, int id_slot);
    std::unique_ptr<server_res_generator> handle_slot_rollback(const server_http_req & req, int id_slot);
    std::unique_ptr<server_res_generator> handle_slot_fork(const server_http_req & req);
